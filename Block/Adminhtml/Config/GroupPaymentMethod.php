...
class GroupPaymentMethod extends \Magento\Config\Block\System\Config\Form\Fieldset
{
    ...
    protected function _getHeaderCommentHtml($element)
    {
        ...
        if (! $this->pm_enabled) {
            return '<div class="comment">' . __("This payment method is not active in the CardGate configuration.") .
                   ' <a target="_blank" href="https://my.cardgate.com">' . __("Please check CardGate settings") .
                   '</a> ' . __("or") .' <a target="_blank" href="https://www.cardgate.com">' .
                   __("contact an accountmanager") . '</a>.</div>';
        }
